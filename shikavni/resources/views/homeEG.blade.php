...
-->
        ...
        <link rel="stylesheet" href="css/bootstrap.minh.css">
                            ...
                            <div class="row">
                                <nav class="navbar navbar-inverse" role="navigation">
                                    <div class="navbar-header">
                                        ...
                                        <a href="#top" class="navbar-brand">Shikvani</a>
                                        <div id="main-nav" class="collapse navbar-collapse">
                                            <ul class="menu-first nav navbar-nav" style="margin-right: 20px;">
                                                ...
                                                <li><a href="#" class="external" target="_parent" rel="nofollow">Login</a></li> 
    ...
    <div class="input-group">
       <div class="input-group-btn">
        <button type="button" class="btn btn-success dropdown-toggle"   data-toggle="dropdown"  aria-haspopup="true" aria-expanded="false">Filter By  <span class="caret"></span></button>
